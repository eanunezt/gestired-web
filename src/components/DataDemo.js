...
export class DataDemo extends Component {
    ...
    componentDidMount() {
        this.recursoService.getCarsMedium().then(data => this.setState({dataTableValue: data}));
        ...
        this.recursoService.getCarsLarge().then(data => this.setState({dataViewValue: data}));
        this.nodeService.getFilesystem(this).then(files => this.setState({documents: files}));
        this.recursoService.getCarsMedium().then(data => this.setState({picklistSourceCars: data}));
        this.recursoService.getCarsSmall().then(data => this.setState({orderlistCars: data}));
