...
export class TemeLine extends Component {
    ...
    constructor() {
        ...
        this.carservice = new RecursoService();
    }
    ...
    componentDidMount() {
        this.carservice.getRecursosSmall().then(data => this.setState({cars: data}));
    }
                ...
                <div className="p-g-12 p-lg-6">
                    <div className="card">
                        ...
                        <DataTable value={this.state.cars}  style={{marginBottom: '20px'}} responsive={true}
                                selectionMode="single" selection={this.state.selectedRecurso} onSelectionChange={(e) => this.setState({selectedRecurso: e.data})}>
